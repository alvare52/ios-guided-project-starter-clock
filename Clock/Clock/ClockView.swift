...
class ClockView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // Piece of paper we're going to draw on (container)
        if let context = UIGraphicsGetCurrentContext() {
            ...
            let largeDotRadius: CGFloat = 6.0 // 12 diameter
    ...
    @objc func timerFired(_ sender: CADisplayLink) {
        // Get current time
        let currentTime = Date() // current date and time
